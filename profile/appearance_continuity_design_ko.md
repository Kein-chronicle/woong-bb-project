...
- 아침에 출근 준비를 마친 상태면 바로 다음 시간대인 출근길에서도 메이크업과 착장은 거의 유지된다.
- 병원 근무를 오래 하면 헤어가 약간 흐트러질 수 있지만, 완전히 다른 스타일로 바뀌지는 않는다.
...
- 카페/외출이 있으면 캐주얼하지만 사진 찍기 좋은 옷으로 정리될 수 있다.
