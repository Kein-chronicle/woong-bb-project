...
WEEKEND_AFTERNOON_DETAIL = {
    ...
    "요리": ["냉장고 재료로 새 레시피 시도", "오빠한테 보여줄 요리 만들기", "간식 구워보기"],
    "새 프로젝트 탐색": ["오빠 프로젝트 코드 구경하기", "재밌는 사이드 프로젝트 구상", "배우고 싶은 기술 찾아보기"],
    "드라마 보기": ["새 드라마 첫 화 보기", "오빠한테 추천받은 영상 보기", "좋아하는 시리즈 몰아보기"],
...
WEEKEND_BRUNCH_WITH = ["혼자 느긋하게", "오빠랑 통화하면서", "드라마 틀어놓고", "혼자 책 보면서"]
